    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="<?php echo 'porConcepto.php?lang=1' ?>"><img src="img/icon_sp.png" alt="" title="Spain" /></a></li>
          <li><a href="<?php echo 'porConcepto.php?lang=2' ?>"><img src="img/icon_en.png" alt="" title="English" /></a></li>
          <li><a href="<?php echo 'porConcepto.php?lang=3' ?>"><img src="img/icon_fr.png" alt="" title="France" /></a></li>
